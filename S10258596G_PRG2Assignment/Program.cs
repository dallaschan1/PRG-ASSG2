...
namespace Assignment2
{
    ...
    class Program
    {
        public static Queue<Order> NormalQueue = new Queue<Order>();
        public static Queue<Order> GoldQueue = new Queue<Order>();
        public static Dictionary<int, Customer> customerDic = new Dictionary<int, Customer>();
        ...
        public static void AddIceCream(Customer selectedCustomer)
        {
